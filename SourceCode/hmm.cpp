...
//To do:
//So far it only works for discrete observation probabilities
//Generalise to all topologies, for testing.
//Have a good look at the E and M step, such that no values are computed twice (e.g. likelihood)
