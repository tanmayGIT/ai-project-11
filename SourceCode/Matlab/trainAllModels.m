%Assumes a set of w words, each containing a set of m observation sequences
%and an array of strings with corresponding words

function models = trainAllModels(all_features,corresponding_words)
