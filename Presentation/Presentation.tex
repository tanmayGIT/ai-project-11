...
\begin{figure}
  \centering
    \includegraphics[width=1 \textwidth]{Images/slidingWindow1.png}
\end{figure}
...
\begin{figure}
  \centering
    \includegraphics[width=1 \textwidth]{Images/slidingWindow2.png}
\end{figure}
...
\begin{figure}
  \centering
    \includegraphics[width=1 \textwidth]{Images/slidingWindow3.png}
\end{figure}
...
\begin{figure}
  \centering
    \includegraphics[width=1 \textwidth]{Images/slidingWindow4.png}
\end{figure}
...
\begin{itemize}
 ...
 \item Short words may be more difficult to recognise as they are more sensible to inter-writer variations.
\end{itemize}

 \begin{beamerboxesrounded}{Possible solutions:}
 \begin{itemize}
  \item Force the model to end the observations sequence in the final state.
  \item Use a more complex observation model. E.g., a MOG.
\end{itemize}
\end{beamerboxesrounded}
...
\begin{table}
\caption{Results averaged over 40 runs}
 \begin{tabular}{|l|c|c|r|}\hline
    ...
    LL ALL , N=6, K=1,  isotropc cov & -179.00 & -272.23 &	197.35\\
    ... & ... & ...& ... \\
 \end{tabular}
\end{table}
...
\begin{itemize}
\item short vs long...
\item More GMM components seems to decrease the accuracy because of .... 
\end{itemize}
}
