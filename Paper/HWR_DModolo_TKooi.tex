...
A pipeline of the preprocessing is shown in Fig. \ref{fig:pipelinePP}, and in the next subsections we will briefly describe all the steps involved.
...
\begin{figure}
 \centering
\includegraphics[width=0.5\textwidth]{features2.png}
